...
RSpec.describe 'Operations API', type: :request do
  ...
  describe 'POST /api/operations/stocks/deposit' do
    let(:valid_attributes) { { operation: { storage_id: storage_id, item_id: item_id, quantity: 15 } } }

    context 'when request is valid' do
      before { post '/api/operations/stocks/deposit', params: valid_attributes, headers: headers }
    ...
    context 'when request is invalid' do
      before { post '/api/operations/stocks/deposit', params: {operation: {quantity: 15}}, headers: headers }
  ...
  describe 'POST /api/operations/stocks/withdraw' do
    ...
    context 'when request is valid' do
      before { post '/api/operations/stocks/deposit', params: valid_deposit, headers: headers }
      before { post '/api/operations/stocks/withdraw', params: valid_withdraw, headers: headers }
    ...
    context 'when request is valid but quantity is lesser than zero' do
      before { post '/api/operations/stocks/withdraw', params: invalid_withdraw, headers: headers }
    ...
    context 'when request is invalid' do
      before { post '/api/operations/stocks/withdraw', params: {operation: {quantity: 20}}, headers: headers }
  ...
  describe 'POST /api/operations/stocks/transfer' do
    let(:valid_deposit) { { operation: { storage_id: storage_id, item_id: item_id, quantity: 20 } } }
    ...
    context 'when request is valid' do
      before { post '/api/operations/stocks/deposit', params: valid_deposit, headers: headers }
      before { post '/api/operations/stocks/transfer', params: valid_transfer, headers: headers }
  ...
  describe 'POST /api/operations/stocks/:stock_id/set_minimum' do
    let(:valid_stock) { create(:stock) }
    let(:stock_id) { valid_stock.id }
    let(:valid_request) { { minimum_quantity: 2} }

    context 'when request is valid' do
      before { post "/api/operations/stocks/#{stock_id}/set_minimum", params: valid_request, headers: headers }

      it 'sets a minimum quantity of stock to an item in a storage' do
        expect(response.body).to be_empty
      end
